Feature: Finding resources based on current resource
  ...
  Scenario: Going from models
    ...
    When I run command "projectile-rails-current-resource" selecting "app/controllers/users_controller.rb"
  ...
  Scenario: Going from controllers
    ...
    And I turn on projectile-mode
    When I run command "projectile-rails-current-resource" selecting "app/models/user.rb"
  ...
  Scenario: Going from libs
    ...
    And I turn on projectile-mode
    When I run command "projectile-rails-current-resource" selecting "spec/lib/logging_spec.rb"
