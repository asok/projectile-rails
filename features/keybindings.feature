Feature: Keybindings
  ...
  Scenario: Having the find keybindings setup after enabling the mode
    ...
    And  key "C-c r s" should be mapped to "projectile-rails-find-spec"
    And  key "C-c r f" should be mapped to "projectile-rails-find-feature"
    And  key "C-c r S" should be mapped to "projectile-rails-find-current-spec"
    ...
    And  key "C-c r #" should be mapped to "projectile-rails-find-stylesheet"
  ...
  Scenario: Having the commands keybindings setup after enabling the mode
    Given I open the app file "app/models/foo.rb"
    When I turn on projectile-mode
    Then key "C-c r r" should be mapped to "projectile-rails-console"
    And  key "C-c r R" should be mapped to "projectile-rails-server"
    And  key "C-c r k" should be mapped to "projectile-rails-rake"
    And  key "C-c r t" should be mapped to "projectile-rails-generate"
  ...
  Scenario: Having the goto keybindings setup after enabling the mode
    Given I open the app file "app/models/foo.rb"
    When I turn on projectile-mode
    Then key "C-c r g v" should be mapped to "projectile-rails-find-current-view"
    And  key "C-c r g m" should be mapped to "projectile-rails-find-current-model"
    And  key "C-c r g c" should be mapped to "projectile-rails-find-current-controller"
    And  key "C-c r g s" should be mapped to "projectile-rails-find-current-spec"
    And  key "C-c r g n" should be mapped to "projectile-rails-find-current-migration"
    And  key "C-c r RET" should be mapped to "projectile-rails-goto-file-at-point"
    ...
    And  key "C-c r g h" should be mapped to "projectile-rails-goto-schema"
    And  key "C-c r g p" should be mapped to "projectile-rails-goto-spec-helper"
